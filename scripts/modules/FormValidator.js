class FormValidator {
    ...
    _resetValidation() {
        ...
        this._toggleBtnState(this._inputList, this._formElement.querySelector(this._settings.submitButtonSelector));
        this._inputList.forEach((inputElement) => {_hideInputError(this._formElement, inputElement, this._settings);
        });
    }
